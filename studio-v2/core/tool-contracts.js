...
export const TOOL_CONTRACTS = Object.freeze([
  ...
  { name: "undo_revision", description: "Undo the latest draft revision through a human-approved document mutation.", inputSchema: objectSchema({ expectedRevision: revision }, ["expectedRevision"]) },
