export default {
  ...
  "source.none": "none", "confirm.applySource": "The source escape hatch will change: {changed}\nErrors: {errors}\nApply atomically to the draft?",
  "toast.applied": "Applied Revision {revision}", "toast.applyFailed": "Cannot apply: {message}", "error.logoRequired": "Enter at least one Logo URL first",
