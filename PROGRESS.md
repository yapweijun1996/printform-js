...
- Inspector header actions: New, Review, Sessions, Settings and Close now use inline SVG icons; UI i18n unit 25/25 and current Chromium E14/AI/Inspector regressions 16/16 passed; no gate credit.
