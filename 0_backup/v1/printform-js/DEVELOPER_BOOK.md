...
- Or run the built-in Node dev server: `npm run dev` (watch mode: `npm run dev:watch`).
...
- The distributable single-file bundle is `dist/printform.js` (generated by `scripts/build.js`).
