...
Prepared: 2026-09-11; last audited after the current-source application/browser-matrix, Demo transaction evidence, the Service Worker correction, the locale-menu UI correction, the standalone Print preview correction, the floating AI launcher removal, the Print preview SVG conversion, the Validate SVG conversion and the Inspector header SVG conversion. Current review revision: `f9abc49`; Inspector header SVG amendment: `f9abc49`; Validate SVG amendment: `e62a6db`; Validate regression-test commit: `16e6982`; prior Print preview SVG amendment: `1470b03`; prior floating-launcher amendment: `f7ece3e`; prior Print preview amendment: `b89eb09`; prior locale-menu UI amendment: `7628a96`; prior Service Worker amendment: `5341d7acf1cbf7b9f3911015fc31ffcba469b67c`; prior application review revision: `a4caf93857669e05d0d521567ecf5ab6f4389df5`; Windows Firefox runner commit: `93a4f2055f9e30dc75f7df06c9e4ba3c1baebff0`; P0 confirmation-test commit: `59f4fe7`; documentation control commit: `60c28dd0a863c72918273fa0ab87830f940aceb`.
